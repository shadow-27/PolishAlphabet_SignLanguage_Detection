...
# function to store 0's in coordinates list on good places. Every list, no matter how many frames read has to have
# the same length. 0 will not be read anyway. indexes to store how we will pick frames according to how many are they
